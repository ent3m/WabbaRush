...
public partial record GameData
{
    ...
    private static readonly IReadOnlyDictionary<Game, GameData> Games = new Dictionary<Game, GameData>
    {
...

        {
            Game.Fallout3, new GameData
            {
                ...
                SteamIDs = [22300, 22370], // base game and GotY
                GOGIDs = [1454315831], // GotY edition
        ...
        },
        {
            Game.FalloutNewVegas, new GameData
            {
                ...
                SteamIDs = [22380, 22490], // normal and RU version
                GOGIDs = [1454587428],
                EpicGameStoreIDs = ["dabb52e328834da7bbe99691e374cb84"],
                CanSourceFrom = [Game.Fallout3],
        ...
        },
        {
            Game.Skyrim, new GameData
            {
                ...
                SteamIDs = [72850],
                CommonlyConfusedWith = [Game.SkyrimSpecialEdition, Game.SkyrimVR],
        ...
        },
        {
            Game.SkyrimSpecialEdition, new GameData
            {
                ...
                CommonlyConfusedWith = [Game.Skyrim, Game.SkyrimVR],
        ...
        },
        {
            Game.Fallout4, new GameData
            {
                ...
                SteamIDs = [377160],
                GOGIDs = [1998527297],
                CommonlyConfusedWith = [Game.Fallout4VR],
                CanSourceFrom = [Game.Fallout76],
        ...
        },
        {
            Game.SkyrimVR, new GameData
            {
                ...
                MO2ArchiveName = "skyrimse",
                SteamIDs = [611670],
                CommonlyConfusedWith = [Game.Skyrim, Game.SkyrimSpecialEdition],
                CanSourceFrom = [Game.SkyrimSpecialEdition],
        ...
        },
        {
            Game.Enderal, new GameData
            {
                ...
                SteamIDs = [1027920, 933480],
                CommonlyConfusedWith = [Game.EnderalSpecialEdition],
        ...
        },
        {
            Game.EnderalSpecialEdition, new GameData
            {
                ...
                SteamIDs = [976620],
                GOGIDs = [1708684988],
                CommonlyConfusedWith = [Game.Enderal],
        ...
        },
        {
            Game.Fallout4VR, new GameData
            {
                ...
                MO2ArchiveName = "Fallout4",
                SteamIDs = [611660],
                CommonlyConfusedWith = [Game.Fallout4],
                CanSourceFrom = [Game.Fallout4],
        ...
        },
        {
            Game.DarkestDungeon, new GameData
            {
                ...
                SteamIDs = [262060],
                GOGIDs = [1450711444],
                EpicGameStoreIDs = ["b4eecf70e3fe4e928b78df7855a3fc2d"],
        ...
        },
        {
            Game.Witcher, new GameData
            {
                ...
                SteamIDs = [20900], // normal and GotY
                GOGIDs = [1207658924], // normal, GotY and both in packages
        ...
        },
        {
            Game.Witcher3, new GameData
            {
                ...
                SteamIDs = [292030, 499450], // normal and GotY
                GOGIDs = [1207664643, 1495134320, 1207664663, 1640424747], // normal, GotY and both in packages
        ...
        },
        {
            Game.MechWarrior5Mercenaries, new GameData
            {
                ...
                NexusGameId = 3099,
                EpicGameStoreIDs = ["9fd39d8ac72946a2a10a887ce86e6c35"],
                IsGenericMO2Plugin = true,
        ...
        },
        {
            Game.DragonAgeOrigins, new GameData
            {
                ...
                SteamIDs = [47810],
                OriginIDs = ["DR:169789300", "DR:208591800"],
                EADesktopIDs = [ // Possibly Wrong
        ...
        },
        {
            Game.DragonAge2, new GameData
            {
                ...
                SteamIDs = [1238040],
                OriginIDs = ["OFB-EAST:59474", "DR:201797000"],
                EADesktopIDs = [ // Possibly Wrong
        ...
        },
        {
            Game.DragonAgeInquisition, new GameData
            {
                ...
                SteamIDs = [1222690],
                OriginIDs = ["OFB-EAST:51937", "OFB-EAST:1000032"],
        ...
        },
        {
           Game.Cyberpunk2077, new GameData
           {
                ...
                SteamIDs = [1091500],
                GOGIDs = [2093619782, 1423049311],
                EpicGameStoreIDs = ["5beededaad9743df90e8f07d92df153f"],
        ...
        {
            Game.KingdomComeDeliverance2, new GameData
            {
        ...
        {
            Game.DragonsDogma2, new GameData
            {
        ...
        {
            Game.NieRAutomata, new GameData
            {
    ...
    public static FrozenDictionary<string, GameData> GameLookup = Games.Values
        .DistinctBy(g => g.MO2ArchiveName ?? g.NexusName, StringComparer.InvariantCultureIgnoreCase)
        .ToFrozenDictionary(g => g.MO2ArchiveName ?? g.NexusName ?? "", StringComparer.InvariantCultureIgnoreCase);
}
