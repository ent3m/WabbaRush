...
[GeneratedComClass]
internal partial class CoreWebView2StateChangedHandler : ICoreWebView2StateChangedEventHandler
{
    private readonly Action<ICoreWebView2DownloadOperation?> _callback;
    public CoreWebView2StateChangedHandler(Action<ICoreWebView2DownloadOperation?> callback)
        => _callback = callback;
