...
internal class NexusDownloader : IDisposable
{
    ...
    private readonly RetryHandler circuitBreaker;
    ...
    public NexusDownloader(string downloadFolder, IReadOnlyList<NexusDownload> downloads,
        ...
        RetryHandler circuitBreaker, AutoDownloadCefBrowser browser)
    {
        this.downloadFolder = downloadFolder;
        this.downloads = downloads;
        this.maxDownloadSize = settings.MaxDownloadSizeMB * 1024 * 1024;
        bufferSize = settings.BufferSize;
        checkHash = settings.CheckHash;
        discoverExistingFiles = settings.DiscoverExistingMods;
